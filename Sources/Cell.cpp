...
sf::Color GetColorByCellState(Cell::CellState state)
{
    switch (state)
    {
        case Cell::PASSABLE:
...
sf::String GetMarkByCellState(Cell::CellState state)
{
    switch (state)
    {
        case Cell::OCCUPY_BY_ROBOT:
...
void Cell::Init(const sf::Vector2f& l_windowPosition, float l_sideSize, const sf::Font& l_font)
{
